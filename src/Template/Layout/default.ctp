  ...
  <body>
      ...
      <div class="nav-wrapper grey darken-3">
          ...
          <ul id="nav-mobile" class="right hide-on-med-and-down" style="height: 100%; display: flex; align-items: center;">
            ...
            <?php if($currentUser === null): ?>
              <a href="#modal1"r>Register/Sign in</a>
            <?php else: ?>
              <a class ="logout" style = "width:auto;"><?= $this->Html->link('Logout', 
      ...
      <div class="nav-wrapper grey darken-2 searchbar">
        ...
        <?= $this->Form->create(NULL, ['url' => [
          ...
          <div class="input-field col s6 grey darken-3 search-cat">
            <select class="browser-default grey search-select" style="border-radius: 0;">
          ...
          <div class="input-field grey lighten-3" style="width:100%; height: 99.99%;">
            <input id="txtkey" name="tags" type="search" placeholder="search..." aria-describedby="ddlsearch" style="padding-left: 1rem; width: 97.5%;" required>
            <label for="search"></label>
          </div>
          
          <button class="btn grey searchbutton" type="submit" name="action" style="height: inherit; border-radius: 0; box-shadow: none;">
            <i class="material-icons right" style="height: 50px; line-height: 50px;">search</i>
          </button>
          <?= $this->Form->end() ?>
        </form>
      </div>
      ...
      <div class="modal-content">
        <h5><center>LOG IN</center></h5>
          ...
          <div class="row">
            ...
            <?= $this->Form->create(null, [‘url’ => [‘controller’ => ‘RegisteredUsers’, ‘action’ => ‘login’], 'class'=>'col s12']); ?>
              ...
              <div class="col s6">
                ...
                <div class="row">
                  <center><a href="#!" class="modal-action modal-close waves-effect btn grey darken-2">SIGN IN</a></center>
                </div>
    ...
    <div id="modal2" class="modal">
      ...
      <div class="modal-content">
        ...
        <?= $this->Form->create(null, [‘url’ => [‘controller’ => ‘RegisteredUsers’, ‘action’ => ‘login’]]); ?>
          <div class="row">
            <div class="col s6">
      ...
      <div class="container">
        <div class="row">
          <div class="col l6 s12">
            <h5 class="white-text">GatorBay</h5>
