...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $sellingList->registered_user_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $sellingList->registered_user_id)]
            )
        ?></li>
...
<div class="sellingLists form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Selling List') ?></legend>
        <?php
        ?>
    </fieldset>
