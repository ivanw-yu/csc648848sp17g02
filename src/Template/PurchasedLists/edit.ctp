...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $purchasedList->registered_user_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $purchasedList->registered_user_id)]
            )
        ?></li>
...
<div class="purchasedLists form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Purchased List') ?></legend>
        <?php
        ?>
    </fieldset>
