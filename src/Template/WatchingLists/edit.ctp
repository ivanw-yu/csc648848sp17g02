...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $watchingList->registered_user_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $watchingList->registered_user_id)]
            )
        ?></li>
...
<div class="watchingLists form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Watching List') ?></legend>
        <?php
        ?>
    </fieldset>
