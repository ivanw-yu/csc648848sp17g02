...
<div class="soldLists index large-9 medium-8 columns content">
    <h3><?= __('Sold Lists') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($soldLists as $soldList): ?>
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $soldList->registered_user_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $soldList->registered_user_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $soldList->registered_user_id], ['confirm' => __('Are you sure you want to delete # {0}?', $soldList->registered_user_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
